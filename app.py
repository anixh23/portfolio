...
st.write(
    """
🚧 AI Chat Bot Using Python ,Tkinter and Open Ai Libraries
🚧 Notes And Password Managaer using Tkinter and Python
🚧 133 Languages Translator Bot Using Python and Tkinter
🚧 Resumes ,GUIs and Music Players using Python and Tkinter
""")
